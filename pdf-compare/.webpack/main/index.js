...
/* harmony import */ var net__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(net__WEBPACK_IMPORTED_MODULE_4__);
...
let flaskPort = 5000;
electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.handle('get-flask-port', () => {
  return flaskPort;
});
function getFreePort() {
  return new Promise((resolve, reject) => {
    const srv = net__WEBPACK_IMPORTED_MODULE_4___default().createServer();
    srv.listen(0, () => {
...
const startFlask = async () => {
  ...
  const isWin = os__WEBPACK_IMPORTED_MODULE_3___default().platform() === 'win32';
  ...
  if (isDev) {
    ...
    const rootPath = electron__WEBPACK_IMPORTED_MODULE_0__.app.getAppPath();
    pythonExecutable = path__WEBPACK_IMPORTED_MODULE_1___default().join(rootPath, 'backend', venvPython);
    scriptPath = path__WEBPACK_IMPORTED_MODULE_1___default().join(rootPath, 'backend', 'app.py');
  } else {
    // In prod, point to packaged resources
    scriptPath = path__WEBPACK_IMPORTED_MODULE_1___default().join(process.resourcesPath, 'backend', 'app.py');
  }
  console.log(`Starting Flask with python: ${pythonExecutable}`);
  console.log(`Script path: ${scriptPath}`);
  flaskProcess = (0,child_process__WEBPACK_IMPORTED_MODULE_2__.spawn)(pythonExecutable, [scriptPath], {
    env: {
      ...process.env,
...
const createWindow = () => {
  ...
  const mainWindow = new electron__WEBPACK_IMPORTED_MODULE_0__.BrowserWindow({
    ...
    height: 600,
    webPreferences: {
      preload: '/app/pdf-compare/.webpack/renderer/main_window/preload.js',
